...
const formatMessage = function (message: string | ArrayBuffer | ArrayBufferView) {
...
export const createMethod = function (bits): {array: (d: Uint8Array)=>Uint8Array} {
...
var createHmacOutputMethod = function (outputType, bits) {
    return function (key, message) {
        return new (HmacSha512 as any)(key, bits, true).update(message)[outputType]();
    };
};
